...
import telegram
from JinMoriRobot import TIGERS, WOLVES, dispatcher
from JinMoriRobot.modules.disable import DisableAbleCommandHandler
from JinMoriRobot.modules.helper_funcs.chat_status import (bot_admin,
                                                           can_restrict,
                                                           is_user_admin,
                                                           user_admin,
                                                           user_admin_no_reply)
...
from JinMoriRobot.modules.helper_funcs.string_handling import split_quotes
from JinMoriRobot.modules.log_channel import loggable
from JinMoriRobot.modules.sql import warns_sql as sql
...
def warn(user: User,
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # JinMori's sticker
        keyboard = None
