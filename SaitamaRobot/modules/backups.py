...
import JinMoriRobot.modules.sql.notes_sql as sql
from JinMoriRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from JinMoriRobot.__main__ import DATA_IMPORT
from JinMoriRobot.modules.helper_funcs.chat_status import user_admin
from JinMoriRobot.modules.helper_funcs.alternate import typing_action

# from JinMoriRobot.modules.rules import get_rules
import JinMoriRobot.modules.sql.rules_sql as rulessql

# from JinMoriRobot.modules.sql import warns_sql as warnssql
import JinMoriRobot.modules.sql.blacklist_sql as blacklistsql
from JinMoriRobot.modules.sql import disable_sql as disabledsql

# from JinMoriRobot.modules.sql import cust_filters_sql as filtersql
# import JinMoriRobot.modules.sql.welcome_sql as welcsql
import JinMoriRobot.modules.sql.locks_sql as locksql
from JinMoriRobot.modules.connection import connected
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                "An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @GodOfHighSchoolSupport"
            )
...
def export_data(update, context):
    ...
    f = open("JinMoriRobot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("JinMoriRobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `JinMoriRobot-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("JinMori{}.backup".format(chat_id))  # Cleaning file
