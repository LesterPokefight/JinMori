...
from JinMoriRobot import (DEL_CMDS, DEV_USERS, DRAGONS, SUPPORT_CHAT, DEMONS,
...
def sudo_plus(func):
    ...
    def is_sudo_plus_func(update: Update, context: CallbackContext, *args,
        ...
        if user and is_sudo_plus(chat, user.id):
            ...
            update.effective_message.reply_text(
                "Who this non-admin telling me what to do? You want a kick?")
...
def bot_admin(func):
    ...
    def is_admin(update: Update, context: CallbackContext, *args, **kwargs):
        ...
        if update_chat_title == message_chat_title:
            not_admin = "I'm not admin in this chat! - F"
        else:
            not_admin = f"I'm not admin in this chat <b>{update_chat_title}</b>! - F"
...
from JinMoriRobot.modules import connection
